...
REM ============================================================
REM   install.bat - 星尘闪连 (Stardust Flash Link) 服务安装脚本 (v1.4.0)
...
echo.
echo ============================================================
echo   星尘闪连 (Stardust Flash Link) - Windows 服务安装 (v1.4.0)
echo ============================================================
...
"!NSSM!" set DrcomAutoLogin Description "星尘闪连 (Stardust Flash Link) - Dr.COM 校园网自动登录（v1.4.0）"
