...
REM ============================================================
REM   install.bat - Dr.COM 校园网自动登录服务安装脚本 (v1.3-fix)
...
echo.
echo ============================================================
echo   Dr.COM 校园网自动登录 - Windows 服务安装 (v1.3-fix)
echo ============================================================
...
"!NSSM!" set DrcomAutoLogin Description "Dr.COM 校园网认证 - Web UI 配置版 v1.3-fix"
