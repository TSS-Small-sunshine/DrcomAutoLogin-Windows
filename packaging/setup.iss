...
;   目标: 生成 StardustFlashLink-Setup-v2.0.2.exe
; ============================================================
...
begin
  ...
  Exec(NSSM, 'set DrcomAutoLogin Description "星尘闪连 (Stardust Flash Link) - Dr.COM 校园网自动登录（v2.0.2）"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
