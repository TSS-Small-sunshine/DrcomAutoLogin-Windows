...
begin
  ...
  Exec(NSSM, 'set DrcomAutoLogin Description "Dr.COM 校园网认证 - Web UI 配置版 v1.3-fix"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
